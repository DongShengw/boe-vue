<template>
  <div v-wechat-title="$route.meta.title"  style="width: 100%; height: 100vh; overflow: hidden" class="background">
    <div style="width: 600px; margin: 180px auto" >
      <el-card shadow="always">
        ...
        <el-form ref="form" :model="form" size="large" :rules="rules" >
          ...
          <!--        登录按钮-->
          <el-form-item>
            <el-button type="primary" style="width: 50%;  margin: 0 auto; font-size: 16px" @click="login">登录</el-button>
          </el-form-item>
          <!--        注册按钮-->
          <el-form-item>
            <el-button type="primary" style="width: 50%; margin: 0 auto ;font-size: 16px " @click="register">注册</el-button>
          </el-form-item>
